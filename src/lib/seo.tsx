...
export const getSEOTags = ({
  ...
  return {
    ...
    metadataBase: new URL(
      process.env.NODE_ENV === "development" ? "http://localhost:3000/" : `https://${general.domainName}/`,
    ),
    ...
    openGraph: {
      ...
      siteName: openGraph?.title || general.appName,
      // If you add an opengraph-image.(jpg|jpeg|png|gif) image to the /app folder, you don't need the code below
      // images: [
      //   {
      //     url: `https://${general.domainName}/share.png`,
      //     width: 1200,
      //     height: 660,
      //   },
      // ],
    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          image: `https://${general.domainName}/icon.png`,
